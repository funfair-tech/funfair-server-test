...
internal sealed class XunitLoggerProvider : ILoggerProvider
{
    ...
    {
        return new XunitLogger(output: this._output, category: categoryName, minLogLevel: this._minLevel, logStart: this._logStart, semaphore: TestOutputLocking.TestLock);
    }
