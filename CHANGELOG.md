...
- Dependencies - Updated Meziantou.Analyzer to 3.0.287
### Deprecated
### Removed
### Deployment Changes
...
- Dependencies - Updated Microsoft.Extensions to 10.10.0
...
- Use TimeProvider.System instead of DateTimeOffset.UtcNow/Now directly in XUnitLoggerBase, resolving an analyzer-suppression conflict (FFS0004/FFS0005 vs FFS0049).
- Corrected a duplicated-word typo ("but not found found errors in") in ComplexValidatorTestBase assertion failure messages
### Changed
...
- Dependencies - Updated FunFair.CodeAnalysis to 7.2.10.2209
...
- Dependencies - Updated xunit.runner.visualstudio to 3.1.5
...
## [6.1.284] - 2025-08-10
### Changed
- Dependencies - Updated Meziantou.Extensions.Logging.Xunit to 1.1.11
...
- Dependencies - Updated Meziantou.Extensions.Logging.Xunit to 1.1.10
...
- Dependencies - Updated xunit.runner.visualstudio to 3.1.3
...
- Dependencies - Updated Bogus to 35.6.2
...
## [6.1.233] - 2024-10-28
### Changed
- Dependencies - Updated Meziantou.Framework.InlineSnapshotTesting to 3.2.0
...
- Dependencies - Updated Meziantou.Framework.InlineSnapshotTesting to 3.0.11
...
- Dependencies - Updated Meziantou.Framework.InlineSnapshotTesting to 3.0.9
...
- Dependencies - Updated Dapper to 2.1.44
...
- Dependencies - Updated Meziantou.Framework.InlineSnapshotTesting to 3.0.1
...
- Dependencies - Updated Bogus to 35.4.1
...
- Dependencies - Updated Meziantou.Framework.InlineSnapshotTesting to 3.0.0
...
- Dependencies - Updated Bogus to 35.0.1
...
- Dependencies - Updated Dapper to 2.1.21
...
- FF-1429 - Updated FluentValidation to 11.5.0
...
## [6.0.17] - 2023-01-20
### Changed
- FF-1429 - Updated FluentValidation to 11.4.0
...
- FF-1429 - Updated Castle.Core to 5.1.0
...
## [5.9.9] - 2022-06-27
### Changed
- FF-1429 - Updated FluentValidation.AspNetCore to 11.1.1

## [5.9.8] - 2022-06-26
### Changed
- FF-1429 - Updated FunFair.CodeAnalysis to 5.8.3.1353
- FF-1429 - Updated FluentValidation.AspNetCore to 11.1.0
...
## [5.9.6] - 2022-06-14
### Changed
- FF-1429 - Updated FluentValidation.AspNetCore to 11.0.2
- FF-1429 - Updated Roslynator.Analyzers to 4.1.1
- FF-1429 - Updated SonarAnalyzer.CSharp to 8.40.0.48530
- FF-1429 - Updated FluentValidation.AspNetCore to 11.0.3
...
- Made Configure services return IServiceCollection.
